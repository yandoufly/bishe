...
public class CateAction extends BaseAction {
	...
	public String addCate() {
		this.cateService.save(this.cate);
		return SUCCESS;
	}
	...
	public String getAllCate() {
		...
		tempList = this.cateService.show();
	...
	public String getCateById() {
		this.cate = this.cateService.checkId(this.id);
		return SUCCESS;
	}
	...
	public String queryCateByCond() {
		...
		if ("catename".equals(this.cond)) {
			list = this.cateService.checkByLikeCatename(this.name);
		}
		return SUCCESS;
	}
