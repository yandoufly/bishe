...
<tr valign="top">
<td bgcolor="#FFFFFF">
<s:form action="cate/updateCate.action" name="myform" onsubmit="return check()">
...
修改商品类型
<input type="hidden" name="cate.cateid" value="${cate.cateid}" /></td></tr>
 <tr align="center" bgcolor="#F2FDFF"><td width="20%" align="right">类型名称</td><td align="left"><input type="text" name="cate.catename" style="width:160px" id="catename" value="${cate.catename}" /></td></tr><tr align="center" bgcolor="#ebf0f7">
<td colspan="2">
