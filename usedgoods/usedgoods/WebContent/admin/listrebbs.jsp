			...
			<td bgcolor="#FFFFFF">
				<table width="96%" border="0" align="center" cellpadding="4"
					...
					<tr align="center">
						...
						<td align="center" bgcolor="#ebf0f7">回复时间</td>
						<td align="center" bgcolor="#ebf0f7" width="10%">操作</td>
					</tr>
					<s:iterator value="list" id="list">
						<tr align="center" bgcolor="#FFFFFF">
							<td align="center"><s:property value="usersid" /></td>
							<td align="center"><s:property value="bbsid" /></td>
							<td align="center"><s:property value="contents" /></td>
							<td align="center"><s:property value="addtime" /></td>
							<td align="center"><s:a
									href="rebbs/deleteRebbs.action?rebbs.rebbsid=%{rebbsid}"
