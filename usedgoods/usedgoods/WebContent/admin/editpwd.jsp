...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	%><body>
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
			<tr valign="top">
				<td bgcolor="#FFFFFF">
					<s:form action="admin/editpwd.action" name="myform"
						...
						<table width="40%" border="0" align="center" cellpadding="4"
							...
							<tr align="center" bgcolor="#F2FDFF">
								...
								<td align="left">
									...
									<input type="hidden" name="admin.username" style="width: 160px" id="username" value="<%=session.getAttribute("username") %>" />
								</td>
							</tr>
							<tr align="center" bgcolor="#F2FDFF">
								<td width="20%" align="right">
								...
								<td align="left">
									<input type="password" name="admin.password" style="width: 160px"
										id="password" />
								</td>
							</tr>
							<tr align="center" bgcolor="#F2FDFF">
								...
								<td align="left">
									<input type="password" name="newpassword" style="width: 160px"
										id="newpassword" />
								</td>
							</tr>
							<tr align="center" bgcolor="#F2FDFF">
