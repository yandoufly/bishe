					...
					<table width="40%" border="0" align="center" cellpadding="4"
						...
						<tr align="center" bgcolor="#F2FDFF">
							...
							<td align="left"><input type="text" placeholder="请输入用户名"
								name="admin.username" style="width: 160px" id="username" /></td>
						</tr>
						<tr align="center" bgcolor="#F2FDFF">
						...
						<tr align="center" bgcolor="#F2FDFF">
							...
							<td align="left"><input type="text" placeholder="请输入姓名"
								name="admin.realname" style="width: 160px" id="realname" /></td>
						</tr>
						<tr align="center" bgcolor="#F2FDFF">
							<td width="20%" align="right">联系方式</td>
							<td align="left"><input type="text" placeholder="请输入联系方式"
								name="admin.contact" style="width: 160px" id="contact" /></td>
						</tr>
