...
td {
	...
	setInterval(
			...
			<tr style="background-image: url(images/top_bg.gif); height: 16px">
				...
				<td width="60%" align="right" style="color: #000000;">
					<a href="<%=basePath%>admin/prePwd.action" target="main">修改密码</a>
					<a href="<%=basePath%>admin/exit.action" target="_parent">退出系统</a>
				</td>
			</tr>
		</table>
	</body>
