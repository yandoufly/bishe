			...
			<div class="box">
				<div class="box_1">
					<div class="userCenterBox boxCenterList clearfix"
						...
						<div class="blank"></div>
						<form name="formEdit" action="index/addGoods.action" method="post">
							<table width="100%" border="0" cellpadding="5" cellspacing="1"
								bgcolor="#dddddd">
								<tr>
									<td width="28%" align="right" bgcolor="#FFFFFF">商品名称：</td>
									<td width="76%" align="left" bgcolor="#FFFFFF"><input
										type="text" placeholder="请输入商品名称" name="goods.goodsname"
								...
								<tr>
									...
									<td width="76%" align="left" bgcolor="#FFFFFF"><input
										type="text" placeholder="请选择图片" name="goods.image1" size="25"
								...
								<tr>
									...
									<td width="76%" align="left" bgcolor="#FFFFFF"><input
										type="text" placeholder="请选择图片" name="goods.image2" size="25"
								...
								<tr>
									...
									<td width="76%" align="left" bgcolor="#FFFFFF"><input
										type="text" placeholder="请选择图片" name="goods.image3" size="25"
								...
								<tr>
									...
									<td width="76%" align="left" bgcolor="#FFFFFF"><input
										type="text" placeholder="请选择图片" name="goods.image4" size="25"
								...
								<tr>
									...
									<td width="76%" align="left" bgcolor="#FFFFFF"><input
										type="text" placeholder="请输入价格" name="goods.price" size="25"
										class="inputBg" id="price" /></td>
								</tr>
								<tr>
									<td width="28%" align="right" bgcolor="#FFFFFF">库存：</td>
									<td width="76%" align="left" bgcolor="#FFFFFF"><input
										type="text" placeholder="请输入出版社" name="goods.storage" size="25"
								...
								<tr>
									...
									<td width="76%" align="left" bgcolor="#FFFFFF"><script
											...
											cols="80" name="goods.contents" id="contents" rows="10">在此添加内容 </textarea>
