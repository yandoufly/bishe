...
<div class="rightbox">
	...
	<div class="morebt">
		<ul id="ulStudMsgHeadTab">
			<li><a class="tab1" onclick="" href="${pageContext.request.contextPath}/teacher/questionList.action">查看问题</a></li>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<c:forEach items="${questList }" var="question" varStatus="vs">
					<tr align="center">
						...
						<td><a href="${pageContext.request.contextPath}/teacher/showQuestion.action?question.id=${question.id}">查看</a></td>
					</tr>
				</c:forEach>
			</table>
		</form>
