	...
	<div class="page">
		<div class="box mtop">
			...
			<div class="rightbox">
				...
				<div class="cztable">
				<form action="${pageContext.request.contextPath }/admin/classroom_edit.action" method="post">
					<table width="100%" cellpadding="0" cellspacing="0">
						<tr>
							<td align="right">编号：</td>
							<td><s:textfield name="classroom.classroomId" readonly="true"/></td>
